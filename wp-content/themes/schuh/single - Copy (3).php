...
<li class="slidertest" style="background-color:<?php echo get_post_meta($post->ID, '360_background_color',true);?>" databg="<?php echo get_post_meta($post->ID, '360_background_color',true);?>">

				<div class="slide_img" id="<?php echo get_post_meta($post->ID,'color_picker',true);?>"><div  class="Sirv" id="light" data-effect="spin" 
...
?>
               ...
               <div class="thumb_slider">
                      ...
                      <div class="slideshow vertical" 
						  ...
						  <?php if($link_360!='') { ?> <img src="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo $thumb_360; ?>&amp;w=294&h=250&amp;zc=1&a=tl" onerror="this.src='<?php echo get_template_directory_uri(); ?>/timthumb.php?src=http://192.168.0.62/schuh/wp-content/uploads/2014/07/Koala.jpg&amp;w=294&h=250&amp;zc=1&a=tl'"/><?php } ?>
