...
//	alert(bgAttr);
	...
	// jQuery('#flexslider .slides li img').css('height',actualHeight);
...
function cartButton() {
	...
	//jQuery('#flexslider .slides li').height(jQuery(window).height());
	//jQuery('#flexslider .slides li img').css({height: jQuery(window).height()});	
...
function fullScreenSlider() {
 ...
 var winHeight = jQuery(window).height()-150;
	  var winHeight360 = jQuery(window).height()-150;
	 jQuery('.slide_img').css({
	  height: winHeight,
	  width: winWidth 
	 });
...
jQuery(window).resize(function() {
	...
	jQuery('.inner_content').css('height', actualHeight);
	// jQuery('#flexslider .slides li img').css('height', actualHeight);
	// jQuery('#flexslider .slides li img').css('width', 'auto');
	jQuery('.home_content').css('height', winHeight);
})
});
