...
?>
               <div class="thumb_slider deskstop" id="desktop">
                      <div class="slideshow vertical"
                          ...
                          id="control_nav">
						  <?php if($link_360!='') { ?> <img src="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=http://wp.draftserver.com/schuh/wp-content/uploads/2014/07/3601.png&amp;w=294&h=250&amp;zc=1&a=tl" id="toggle-360" class="active"/><?php } ?>
...
<?php } ?>                       
                      ...
                      <div class="slideshow"
                          ...
                          data-allow-wrap=false 
                          id="control_nav">
              <?php if($link_360!='') { ?> <img src="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=http://wp.draftserver.com/schuh/wp-content/uploads/2014/07/3601.png&amp;w=294&h=250&amp;zc=1&a=tl" id="toggle-360_2" class="active"/><?php } ?>
<?php foreach($my_query as $query2) {?>
<img src="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo $query2['logos_items']; ?>&amp;w=294&h=250&amp;zc=1&a=tl" class="img_nav"/>
<?php } ?>
                        </div>
