...
if(!defined('Magic360ModuleCoreClassLoaded')) {
    ...
    class Magic360ModuleCoreClass {
        ...
        function headers($jsPath = '', $cssPath = null, $notCheck = false) {
            ...
            $headers = array();
            // add module version
            $headers[] = '<!-- Magic 360 WordPress module version v5.12.2 [v1.4.12:v4.5.14] -->';
            // add style link
