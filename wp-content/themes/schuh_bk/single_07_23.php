...
?>
  ...
  jQuery(document).ready(function() {
   jQuery('.flexslider').flexslider({
    ...
    slideshow:false,
	    reverse:true,
 manualControls:"#control_nav .img_nav",
	 start: function() {
...
?>
               ...
               <div class="thumb_slider">
                      ...
                      <div class="slideshow vertical" 
						  ...
						  <?php if($link_360!='') { ?>
<img src="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo $thumb_360; ?>&amp;w=294&h=250&amp;zc=1&a=tl" onerror="this.src='<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo $thumb_360;?>&amp;w=294&h=250&amp;zc=1&a=tl'" id="toggle-360" class="active"/>

						<!--  <img src="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo $thumb_360; ?>&amp;w=294&h=250&amp;zc=1&a=tl"id="toggle-360" class="active"/><?php } ?>-->
