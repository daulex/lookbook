...
$script_path = preg_replace('/(.+)wp-content\/themes\/schuh\/timthumb.php$/', '$1', $_SERVER['SCRIPT_NAME']);

$base_url = "http://" . $_SERVER["HTTP_HOST"] . $script_path;

//echo $base_url; die();

$stripped_path = str_replace($base_url, "", $src);
//echo $stripped_path."finalpath"; die(); 
...
// getting dimensions of watermark image
    ...
    //echo $watermark_width; die('hjih');

    // $image_path = 'original.jpg';
    
    //echo $mainSource; 
    //$image = imagecreatefromjpeg($canvas);
