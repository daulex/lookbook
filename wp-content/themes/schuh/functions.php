...
function my_attachments( $attachments )
{
  ...
  $args = array(
    ...
    'post_type'     => array('heels','boots','sports','flats'),
...
function mt_add_pages() {
 add_menu_page('Order', 'Orders', '5', 'orders', 'my_mem_page');
}
// mt_toplevel_page() displays the page content for the custom Test Toplevel menu
function my_mem_page() {
...
function get_image_by_sku($post_id){
	// $my_query=get_post_meta($post_id,'logo_list',true);
	// if($my_query!=null){
	// 	$my_query['logos_items'];
	// }
