...
/*$demo='INSERT INTO sc78_productdetail(user_id, product_number, image_sample,pair_single) VALUES("'.$user_id.'","'.$my_var.'","'.$_POST[$zombie].'","'.$_POST[$zombie].'")';
echo $demo;die;
*/
//echo $_POST['myimage_'.$my_var];die;
...
//echo '<img src="'.wp_get_attachment_url( get_post_thumbnail_id($my_var) ).'">';
}

$personal_info.='</table>';
 $headers = 'From: Schuh <dark23shadow@gmail.com>' . "\r\n";
		$headers .= "MIME-Version: 1.0\r\n";
		 $headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
		//add_filter( 'wp_mail_content_type', 'set_html_content_type' );


		wp_mail('dark23shadow@gmail.com', 'This is from schuh',$personal_info,$headers);
