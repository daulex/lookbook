...
function WordPress_Magic360_send_stat($action = '') {
    ...
    if('working' == 'v5.12.2' || 'working' == 'v4.5.14') {
        return;
    }
    ...
    $path = "api/stat/?action={$action}&tool_name=magic360&license=commercial&tool_version=v4.5.14&module_version=v5.12.2&platform_name=wordpress&platform_version={$platformVersion}&url={$url}";
...
function  magictoolbox_WordPress_Magic360_init() {
    ...
    add_action("wp_head", "magictoolbox_WordPress_Magic360_styles"); //load scripts and styles
...
function  magictoolbox_WordPress_Magic360_config_page($id) {
    ...
    <p>Learn about all the <a href="http://www.magictoolbox.com/magic360/integration/" target="_blank">Magic 360&trade; settings and examples too!</a></p>
    <p>To set up a 360 spin, <a href="http://www.magictoolbox.com/magic360/modules/wordpress/">follow the instructions</a> or <a target="_blank" href="http://www.youtube.com/watch?v=R9omDz1JT-M">watch the video</a>.</p>
