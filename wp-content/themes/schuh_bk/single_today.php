...
<?php } ?>
              ...
              <?php if($link_360!='') { ?> <img src="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo $thumb_360; ?>&amp;w=294&h=250&amp;zc=1&a=tl"id="toggle-360_2" class="active"/><?php } ?>
